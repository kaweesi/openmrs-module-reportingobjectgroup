 ...
 * Additionally, there is a perHourDenominator property that allows you to multiply the denominator by a number of hours
 * 
 * @author dthomas
 *
 */
...
//    	COUNT, FRACTION, LOGIC
    	COUNT, FRACTION, PER_DAY, PER_WEEKDAYS, LOGIC
    }
