package org.openmrs.module.reportingobjectgroup.objectgroup;
...
/**
 * This is the basic unit of the ObjectGroupIndicator class.
...
public class ObjectGroup implements Serializable {
	...
	public ObjectGroup() {
		memberIds = new HashSet<Integer[]>(); //[object_id, patient_id]
	}
